...
class Services(models.Model):
    ...
    cost_kiev = models.DecimalField(max_digits=8, decimal_places=2, verbose_name='Вартість Київ')
    cost_murgorod = models.DecimalField(max_digits=8, decimal_places=2, verbose_name='Вартість Миргород')
